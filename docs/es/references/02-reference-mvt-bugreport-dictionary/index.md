...
La información de este archivo se genera mediante el módulo [battery\_history](https://github.com/mvt-project/mvt/blob/main/src/mvt/android/modules/bugreport/battery_history.py) y el artefacto [dumpsys\_battery\_history](https://github.com/mvt-project/mvt/blob/main/src/mvt/android/artifacts/dumpsys_battery_history.py).
