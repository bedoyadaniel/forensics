...
# Guide: How to perform an acquisition and extraction using AndroidQF?
...
If figures on behalf of an organization or other analyst, ask the person for his or her public key [*AGE*](https://github.com/FiloSottile/age) **.** **.
...
!!! note "Check the key pair".
    ...
    Make sure that the private key is the public key pair.
...
* If you have received an encrypted extraction, it is necessary to decrypt this information first, you can refer to the section on [extraction encryption](#extraction-encryption).
