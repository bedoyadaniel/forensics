...
[Androidqf](https://github.com/mvt-project/androidqf) is a forensic extraction tool, part of the [Mobile Verification Toolkit (MVT) project](https://github.com/mvt-project/). It was initially developed by [Claudio Guarnieri](https://nex.sx/) and is actually maintained by  [Amnesty International Security Lab.](https://securitylab.amnesty.org/es/)   
...
This is a compressed file that contains that output of the command `adb shell bugreport` This command generates a [bugreport](https://developer.android.com/studio/debug/bug-report?hl=es-419) that includes a series of system logs, configurations and error reports. 
...
* [How to capture and interpret android bugreport](https://developer.android.com/studio/debug/bug-report?hl=es-419)  
...
* [General description of android processes and subprocesses](https://developer.android.com/guide/components/processes-and-threads?hl=es-419) 
