...
In the context of online safety of at-risk individuals or civil society organizations, a **threat** refers to events or possible situations that could endanger or harm individuals and/or resources, including devices or online accounts. Examples of threats include physical, legal or digital attacks, natural disasters, theft, etc. 

A **vulnerability**, on the other hand, refers to weaknesses in the processes, systems, practices or habits that can lead to threats or increase their impact and consequences. 
...
In the context of forensic support for Civil Society, as described previously in the [explainer on digital forensics for Human Rights Defense](https://forensics.socialtic.org/en/explainers/01-explainer-introduction-digital-forensics/01-explainer-introduction-digital-forensics/#how-can-digital-forensics-be-applied-in-the-defense-of-human-rights), the process usually starts when a Human Rights Defender, journalist or activist **approaches a point of contact or threat lab to request assistance**. In many scenarios, and particularly if they suspect they might be facing an advanced threat, they are likely in a high-risk context, exposed to digital, legal, physical, natural, psychosocial and other threats. **The exact risks an organization or individual face are unique to their context**, and even when forensics do not focus on mitigating or implementing counter measures to manage risks, it is important for points of contacts, analysts and forensic labs to be conscious of such risks for their beneficiaries, and to **avoid engaging in actions that might create further harm** for whomever is in need of support. 

Note that this document analyzes risks primarily *for the forensic labs* supporting human rights defenders, but this principle – avoid engaging in actions that might create further harm – is important for a comprehensive risk analysis and to ensure the safety of individuals that contact the forensic lab.  
   
Moreover, it is important for forensic labs, analysts and points of contact to also consider risks they might face due to their engagement in technical investigations. Through forensic research, civil society organizations **push for accountability measures that can have an impact in the surveillance ecosystem** by uncovering evidence of illegal or unethical practices, which means **some actors will consider forensic research as a threat**. 
...
* **Criminalization of forensic research**: In Ecuador, the Swedish researcher [Ola Bini has been subject to an extensive legal process](https://www.eff.org/deeplinks/2023/03/aftermath-ola-binis-unanimous-acquittal-ecuadorian-court), where even after being declared innocent in 2023 due the lack of evidence, they were then [further prosecuted through appeals](https://peoplesdispatch.org/2024/04/08/activist-ola-bini-sentenced-to-one-year-in-prison-after-ecuadorian-court-overturns-acquittal/).    
...
Forensic labs can also face reputational threats, including through unsubstantiated claims or disinformation. Trolls and misinformation actors can also engage in social media campaigns to discredit and dismiss findings. 
...
Physical attacks have taken place to intimidate, discourage and prevent forensic research from taking place. 
...
As we have mentioned throughout this resource, we encourage forensic labs and researchers supporting civil society to **conduct** **risk assessments exercises regularly**, and particularly before engaging in research with high-risk individuals or when operating from a high-risk location.
