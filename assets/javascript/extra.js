(function () {
    ...
    const iconify_logos = fetch('../external/unpkg.com/@iconify-json/logos@1/icons.json').then((res) => res.json())
        .catch(e => console.error("Failed to fetch Mermaid icon pack:", e));

    // Example of loading additional packs if needed
    const iconify_material = fetch('../external/unpkg.com/@iconify-json/material-symbols@1/icons.json').then((res) => res.json())
        .catch(e => console.error("Failed to fetch Mermaid icon pack:", e));
